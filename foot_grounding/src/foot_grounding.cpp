...
void FootGrounding::initPublisher(ros::NodeHandle node_handle_){
	imu_height_pub_     = node_handle_.advertise<std_msgs::Float32>("imu_height_out", 10);
	imu_height_vel_pub_	= node_handle_.advertise<std_msgs::Float32>("imu_height_vel_out", 10);
	imu_height_acc_pub_	= node_handle_.advertise<std_msgs::Float32>("imu_height_acc_out", 10);
...
//	imu_ground_pose_pub_	= node_handle_.advertise<nav_msgs::Odometry>("imu_ground_pose_out", 1);
	r_pose_pub_	= node_handle_.advertise<nav_msgs::Odometry>("r_pose_out", 10);
	l_pose_pub_	= node_handle_.advertise<nav_msgs::Odometry>("l_pose_out", 10);
	r_ratio_pub_= node_handle_.advertise<std_msgs::Float32>("r_ratio_out", 10);
	l_ratio_pub_= node_handle_.advertise<std_msgs::Float32>("l_ratio_out", 10);
	ground_pose_pub_ = node_handle_.advertise<geometry_msgs::PoseStamped>("ground_pose_out", 10);
}
