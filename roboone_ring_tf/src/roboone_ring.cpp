...
//	imu_quaternion_sub_ = node_handle_.subscribe("imu_quaternion_in", 1,&RobooneRing::getImuQuaternionCallback, this);
//	joint_states_sub_ = node_handle_.subscribe("joint_states_in", 1,&RobooneRing::getJointStatesCallback, this);
}
...
int RobooneRing::groundingMainLoop(){
	//新しいデータが来るまで待機
	usleep(500);//不要なsleep
...
geometry_msgs::TransformStamped RobooneRing::calcRightGroundpoint(){
...
geometry_msgs::TransformStamped RobooneRing::calcLeftGroundpoint(){
	geometry_msgs::TransformStamped toe_tf[4]	={
...
geometry_msgs::TransformStamped RobooneRing::calcFootsCenter(){
...
geometry_msgs::TransformStamped RobooneRing::calcGroundpoint(geometry_msgs::TransformStamped center,geometry_msgs::TransformStamped right_ground,geometry_msgs::TransformStamped left_ground){
...
geometry_msgs::TransformStamped RobooneRing::calcImuGround(geometry_msgs::TransformStamped ground){
