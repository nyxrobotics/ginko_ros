...
{  20,    0,    0,  -50,  -20,    2,   80,    0,   70,   10,  -43, -170,  -40,  -50,  200, 1300, 1250,  -50, -150,-1300,-1250,  -50,  -50,  -39, -100, -131,  207},//初期姿勢(一個目移動時間、二個目待機時間、三個目以降角度)
{  99,    0,    0,  200,   50,  150,   50,    0,  120,   50, -200,   40, -100,    0,    0,    0,    0,    0,    0,    0,    0,   50,  150,   50, -200,    0,    0}//以下モーションデータ(一個目移動時間、二個目待機時間、三個目以降角度)
};

int walkFront_Motion_Loop[8][27]={
